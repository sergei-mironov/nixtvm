...
with tf.Session() as sess:
    ...
    simple_save(sess, export_dir='./saved_variational_autoencoder', inputs={"inp":input_image}, outputs={"out":decoder_export})
