...
# Parameters
learning_rate = 0.01
training_steps = 1000 # FIXME: was 10000
batch_size = 128
display_step = 200
...
def dynamicRNN(x, seqlen, weights, biases):
    ...
    return tf.add(tf.matmul(outputs, weights['out']), biases['out'], name='prediction')
...
with tf.Session() as sess:
    ...
    simple_save(sess, export_dir='./saved_dynamic_rnn', inputs={"inp":x},
